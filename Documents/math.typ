...
#table(
  ...
  [$pi(n)$], [9592], [78498], [664579], [5.76e+6], [5.08e+7]
)
...
$1/(1-x)^d = sum_(n=0)^infinity ""_(n+d-1) "C"_n x^n$
...
$1/(sqrt(1-4x)) = sum_(n=0)^infinity ""_(2n) "C"_n x^n$
...
$C(x)^k = ((1-sqrt(1-4x))/(2x))^k = sum_(n = 0)^infinity k/(n + k) ""_(2n + k - 1) "C"_n$ (カタラン数の母関数の累乗)